<stack>
  Expo SDK 54, React Native 0.76.7, (use npm). only use bun for admin dashboard
  ...
  lucide-react-native for icons.
   All packages are are not installed yet. You need to install whats necessary for your work. install new packages and if necessary install @expo-google-font packages or pure JavaScript helpers like lodash, dayjs, etc.
</stack>
